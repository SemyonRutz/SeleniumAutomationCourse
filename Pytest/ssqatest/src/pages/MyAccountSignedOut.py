...
class MyAccountSignedOut(MyAccountSignedOutLocators):
    ...
    def go_to_my_account(self):
        ...
        logger.info(f"Going to my account page: {my_account_url}") # wtires down the url in the log file
    ...
    def click_login_button(self):
        logger.debug("Clicking 'login' button.") # writes down the message in the log file
